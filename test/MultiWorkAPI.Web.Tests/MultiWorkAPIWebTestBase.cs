...
{
    public abstract class MultiWorkAPIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MultiWorkAPIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MultiWorkAPIWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MultiWorkAPIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MultiWorkAPIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MultiWorkAPIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MultiWorkAPIDbContext, Task<T>> func)
        {
            T result;
