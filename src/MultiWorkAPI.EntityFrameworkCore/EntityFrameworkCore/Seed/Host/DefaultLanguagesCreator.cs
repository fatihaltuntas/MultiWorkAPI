...
namespace MultiWorkAPI.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = MultiWorkAPIConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(MultiWorkAPIDbContext context)
        {
            _context = context;
        }
